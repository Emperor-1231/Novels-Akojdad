#!/usr/bin/python -u
# مستنسخ من Manga Akojdad 

'''
حقوق النشر 2009، The Android Open Source Project

مرخصة تحت رخصة Apache، الإصدار 2.0 (الرخصة)؛
لا يمكنك استخدام هذا الملف إلا وفقًا للرخصة.
يمكنك الحصول على نسخة من الرخصة على العنوان التالي:

  http://www.apache.org/licenses/LICENSE-2.0

ما لم يكن مطلوبًا بموجب القانون أو متفقًا عليه كتابيًا، يتم توزيع البرنامج
على أساس "كما هو"، دون أي ضمانات أو شروط من أي نوع، سواء كانت صريحة أو ضمنية.
انظر الرخصة للحصول على التفاصيل الخاصة باللغة والإذن.
'''
...
if len(package) == 0:
  package.append('com.akojdad.novels')
